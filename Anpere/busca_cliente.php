        ...
        <header>
            ...
            <div class="itens">
                <ul>
                    ...
                    <li><a class="empresa" href="Login-Empresa.php">
                            <p>Login <i class="far fa-user"></i></p>
                        </a></li>
                </ul>
            </div>
        </header>
            ...
            <div class="container-tree">
                ...
                <div class="main-two" id="card_content">
                    ...
                    ?>
                        ...
                        <a style="text-decoration: none;" href="perfilEmpresa.php?id=<?php echo $Result['idEmpresa']; ?>">
                        <div class="card">
                            <div class="image">
