...
if (isset($_GET['keyword'])) {
    ...
    $conditions .= " REPLACE(nomeEmpresa,' ', '') LIKE '$keyword' OR REPLACE(emailEmpresa, ' ', '') LIKE '$keyword' OR REPLACE(	biografiaPerfilEmpresa, ' ', '') LIKE '$keyword' OR REPLACE(tituloPublicacao, ' ', '') LIKE '$keyword' OR REPLACE(descricaoPublicacao, ' ', '') LIKE '$keyword'";
    if (isset($_GET['endereco'])) {
        $conditions .= "AND";
    }
}
...
$query = "SELECT * FROM tbempresa  INNER JOIN tbperfilempresa ON tbperfilempresa.idempresa = tbempresa.idempresa INNER JOIN tbpublicacao ON tbpublicacao.idempresa = tbempresa.idempresa";
...
<div class="container-">
                    ...
                    <div class="itens">
                        ...
                        <ul>
                            ...
                            <li><a class="item-3" href="../Session/destruirSessao.php?pagina=index.php">
                                    <i class="fas fa-power-off" _mstvisible="2"></i> Log out
                                </a></li>
                        </ul>
                    </div>
                </header>
    ...
    <div class="categorias">
        ...
        <div class="icones">
            <a href="busca_cliente.php?category=4">
                <div class="ct"><img src="../resources/images/auau.png"></div>
            </a>
            <a href="busca_cliente.php?category=10">
                <div class="ct"><img src="../resources/images/sofa.png"></div>
            </a>
            <a href="busca_cliente.php?category=1">
                <div class="ct"><img src="../resources/images/sedan.png"></div>
            </a>
            <a href="busca_cliente.php?category=16">
                <div class="ct"><img src="../resources/images/guitarra.png"></div>
            </a>
            <a href="busca_cliente.php?category=9">
                <div class="ct"><img src="../resources/images/cabide.png"></div>
            </a>
            <a href="busca_cliente.php?category=6">
                <div class="ct"><img src="../resources/images/brinquedo.png"></div>
            </a>
            <a href="busca_cliente.php?category=2">
                <div class="ct"><img src="../resources/images/chave-inglesa.png"></div>
            </a>
            <a href="busca_cliente.php?category=18">
                <div class="ct"><img src="../resources/images/estetoscopio.png"></div>
            </a>
            <a href="busca_cliente.php?category=13">
                <div class="ct"><img src="../resources/images/bla.png"></div>
            </a>
            <a href="busca_cliente.php?keyword=&endereco=">
                <div class="ct"><img src="../resources/images/outros.jpg"></div>
            </a>
        </div>
        <div class="icones">
    ...
    <div class="container-two">
        <form method="GET" action="busca_empresa.php">
            <div class="main">
    ...
    <center>
        ...
        <div class="container-fluid justify-content-center" style="width: 38rem !important;" id="content">
            <div class="container-tree">
                                ...
                                foreach ($result as $Result) {
                                    ...
                                    print("<img src='" . $url . "' style='width:38rem !important; height:18rem;'>
                                        ...
                                        <div>
                                            <h5>" . $nome . "</h5>
                                            <p>" . $endereco . "</p>
                                            <a class='btn btn-outline-primary' href='perfilEmpresa_empresa.php?id=" . $idEmpresa . "'>Mais</a>
                                        </div>
                                        </div>");
                ...
                <!-- Google API key de teste: AIzaSyCAckKLHl-T6HPk2pTVfxrjHXf4yLojpfw

                callback=initMap
    
                 Script Google Maps API JS   (Aviso, inserir script de renderização e lógica após declaração do mapa e antes de qualquer implementação)-->

                <script src="../resources/js/maps.js"></script>
                <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCAckKLHl-T6HPk2pTVfxrjHXf4yLojpfw&&libraries=places&v=beta"></script>
                ...
                <div class="main-two" id="card_content">
                    ...
                    ?>
                        ...
                        <a style="text-decoration: none;" href="perfilEmpresa_empresa.php?id=<?php echo $Result['idEmpresa']; ?>">
                        <div class="card">
                            <div class="image">
