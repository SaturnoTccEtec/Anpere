...
<body>
    <div class="container">
        <div class="grid-um">
            ...
            <form method="POST" action="cadastrar-empresa.php" class="form">
                <div>
                ...
                <fieldset style="padding:0; border:none;" class="grupo">
                    ...
                    <div style="float:left;">
                        ...
                        <input id="cnpj" name="txtCnpj" type="number">
                    </div>
                ...
                <fieldset style="padding:0; border:none;" class="grupo">
                    ...
                    <input id="log" name="txtLog" class="logradouro" type="text" required>
                    </div>
                    <div style="float:left; margin-left:6px;">
